  ...
  return (
    <div className="grid grid-cols-12 gap-6" data-testid="home-grid">
      ...
      <aside className="hidden md:block md:col-span-4 lg:col-span-3" data-testid="home-right">
        <div className="sticky top-24 space-y-4">
          <div className="bg-white p-4 rounded-xl shadow border border-gray-200 border border-gray-200"><div className="text-sm font-semibold mb-2">Recomendações</div><div className="flex items-center gap-2 text-sm"><div className="h-7 w-7 rounded-full bg-orange-200"/>Operador Perspicaz<button className="ml-auto text-brand-red text-xs">Seguir</button></div><div className="mt-2 flex items-center gap-2 text-sm"><div className="h-7 w-7 rounded-full bg-indigo-200"/>Agente Analítico<button className="ml-auto text-brand-red text-xs">Seguir</button></div></div>
          <div className="bg-white p-4 rounded-xl shadow border border-gray-200 border border-gray-200"><div className="text-sm font-semibold mb-2">Loja</div><div className="h-24 rounded-lg bg-gray-900 mb-2"></div><button className="bg-brand-red text-white text-sm font-semibold px-3 py-1.5 rounded-lg">Comprar Agora</button></div>
          <div className="bg-white p-4 rounded-xl shadow border border-gray-200 border border-gray-200"><div className="text-sm font-semibold mb-2">Eventos</div><div className="text-sm text-gray-700">Análise coletiva: “Crise 2008” — 26 Set</div></div>
        </div>
        <div className="sticky top-24 space-y-4">
          <div className="bg-white p-4 rounded-xl shadow border border-gray-200 border border-gray-200">Recomendações</div>
          <div className="bg-white p-4 rounded-xl shadow border border-gray-200 border border-gray-200">Loja</div>
          <div className="bg-white p-4 rounded-xl shadow border border-gray-200 border border-gray-200">Eventos</div>
        </div>
        <div className="sticky top-24 space-y-4">
