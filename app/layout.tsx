        ...
        <header className="bg-white sticky top-0 z-50 border-b border-brand-red/40">
          <div className="max-w-7xl mx-auto px-4 py-2 flex items-center justify-between">
            ...
            <div className="flex items-center gap-1">
              ...
              <span className="relative inline-block"><span className="relative inline-block"><button aria-label="Notificações" className="p-2 rounded hover:bg-gray-100">🔔</button><span className="absolute -top-0.5 -right-0.5 h-4 min-w-4 px-1 text-[10px] leading-4 rounded-full bg-brand-red text-white text-center">3</span></span><span className="absolute -top-0.5 -right-0.5 h-4 min-w-4 px-1 text-[10px] leading-4 rounded-full bg-brand-red text-white text-center">3</span></span>
